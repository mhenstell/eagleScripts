...
def parse_path(pathdef, current_pos=Point(x=0, y=0)):
    ...
    while elements:
        ...
        #     current_pos = pos
            ...
            control1 = Point(x=float(elements.pop()), y=float(elements.pop()))
